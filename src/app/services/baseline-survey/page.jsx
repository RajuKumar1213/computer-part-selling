...
export default function BaselineSurveyPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen mt-20 overflow-hidden bg-gradient-to-br from-slate-950 via-orange-950 to-red-950">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                <motion.div
                  ...
                  className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-400/20 to-red-400/20 backdrop-blur-sm border border-orange-400/30 rounded-full text-orange-200"
                >
                ...
                >
                  <button className="px-8 py-4 bg-gradient-to-r from-orange-500 to-red-500 text-white font-semibold rounded-full hover:shadow-2xl hover:shadow-orange-500/25 transition-all duration-300 flex items-center justify-center">
        ...
        <div className="container mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-4">
                {surveyTypes.map((survey, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                    className="flex items-center space-x-3 p-4 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg"
                  >
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative h-96 bg-gradient-to-br from-orange-500 to-red-600 rounded-3xl overflow-hidden shadow-2xl">
                <img
        ...
        <div className="container mx-auto px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-white text-orange-600 font-semibold rounded-full hover:shadow-xl transition-all duration-300">
                Request Proposal
              </button>
              <button className="px-8 py-4 border border-white/30 text-white font-semibold rounded-full hover:bg-white/10 transition-all duration-300">
