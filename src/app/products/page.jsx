        ...
        <div className="container mx-auto px-8">
          ...
          >            <h2 className="text-3xl font-bold text-gray-900 mb-4">Featured Products</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our comprehensive range of POS billing machines designed for modern businesses
            </p>
          </motion.div>          
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-4">
                      <div className="bg-gray-50 p-2 rounded-lg">
                        <span className="text-gray-600 text-xs block mb-1">Brand</span>
                        <span className="font-medium text-gray-900 text-xs">{product.brand}</span>
                      </div>
                      <div className="bg-gray-50 p-2 rounded-lg">
                        <span className="text-gray-600 text-xs block mb-1">Model</span>
                        <span className="font-medium text-gray-900 text-xs">{product.model}</span>
                      </div>
                    </div>
                  </div>
          ...
          >            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 text-white text-center">
              ...
              <p className="text-lg mb-6 text-blue-100">
                Contact our experts for personalized recommendations and bulk pricing
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href={`tel:${companyInfo.whatsappNumber}`}
                  className="inline-flex items-center justify-center gap-2 bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:shadow-xl"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 rounded-full font-semibold transition-all duration-300"
                >
