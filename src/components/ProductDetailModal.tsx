                                ...
                                <div className="flex md:gap-3 gap-2 overflow-x-auto pb-2 h-full ">
                                    {product.images.map((image, index) => (
                                        <button
                                            ...
                                            className={`relative w-16 h-16 md:w-20 md:h-20 rounded-lg overflow-hidden flex-shrink-0 border-2 transition-all ${selectedImageIndex === index
                            ...
                            <div className="space-y-4 md:space-y-6">                                {/* Product Title & Rating */}
                                <div>
                                    <div className="flex items-center gap-2 text-xs md:text-sm text-gray-600 dark:text-gray-400 mb-2">
                                        ...
                                        {product.featured && <span className="bg-gold-100 text-gold-800 px-2 py-1 rounded text-xs">★ Featured</span>}
                                    </div>
                                    <h1 className="text-xl md:text-3xl font-heading font-bold text-gray-900 dark:text-white mb-2">{product.name}</h1>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs md:text-sm text-gray-600 dark:text-gray-400">(4.8/5) • 150+ Reviews</span>
                                    </div>
                                </div>                                {/* Pricing */}
                                <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 p-4 md:p-6 rounded-xl">
                                    <div className="flex items-center gap-4">
                                        <span className="text-2xl md:text-4xl font-heading font-bold text-green-600 dark:text-green-400">{formatPrice(product.price)}</span>
                                    ...
                                    {savings > 0 && (
                                        <p className="text-green-600 dark:text-green-400 font-medium mt-2 text-sm md:text-base">
                                            You save {formatPrice(savings)}!
                                        </p>
                                    )}
                                </div>                                {/* Product Description */}
                                <div>
                                    <h3 className="text-lg md:text-xl font-semibold mb-3 text-gray-900 dark:text-white">Product Description</h3>
                                ...
                                {/* Specifications */}
                                <div>
                                    <h3 className="text-lg md:text-xl font-semibold mb-4 text-gray-900 dark:text-white">Technical Specifications</h3>
                                    <div className="grid gap-3">
                                        {product.specs.map((spec, index) => (
                                            <div key={index} className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                                                <span className="text-sm md:text-base text-gray-800 dark:text-gray-200">{spec}</span>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                        ...
                                        <span className="text-xs md:text-sm font-medium text-green-800 dark:text-green-400">Warranty</span>
                                    </div>
                                    <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                        <Truck className="w-6 h-6 md:w-8 md:h-8 text-blue-600 mx-auto mb-2" />
                                        <span className="text-xs md:text-sm font-medium text-blue-800 dark:text-blue-400">Fast Delivery</span>
                                    </div>
                                    <div className="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                                        <Award className="w-6 h-6 md:w-8 md:h-8 text-purple-600 mx-auto mb-2" />
                                        <span className="text-xs md:text-sm font-medium text-purple-800 dark:text-purple-400">Certified</span>
                                    </div>
                                </div>                                {/* Action Buttons */}
                                <div className="space-y-3 md:space-y-4 pt-4 md:pt-6 border-t dark:border-gray-700">
                                    <div className="grid grid-cols-2 gap-3 md:gap-4">
                                        <button
                                            ...
                                            className="flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white py-3 md:py-4 rounded-xl font-semibold text-sm md:text-base transition-all hover:scale-105 shadow-lg"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white py-3 md:py-4 rounded-xl font-semibold text-sm md:text-base transition-all hover:scale-105 shadow-lg"
                                        >
                                            <Phone className="w-4 h-4 md:w-5 md:h-5" />
                                            Call Now
                                        </button>
                                    </div>
                                    <button className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white py-3 md:py-4 rounded-xl font-semibold text-sm md:text-base transition-all hover:scale-105 shadow-lg">
